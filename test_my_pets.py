...
def test_my_pets_page():
    with Chrome() as browser:
        ...
        wait_until_clickable(browser, By.NAME, 'name')
        browser.find_element_by_name('name').send_keys("Бинго")
        wait_until_clickable(browser, By.NAME, 'age')
        browser.find_element_by_name('age').send_keys("2")
        wait_until_clickable(browser, By.NAME, 'sex')
        browser.find_element_by_name('sex').send_keys("M")
